...
def file_wr(project_name, file_name, first_file):
    with open(f'/home/fsluser/Documents/{project_name}'
              f'/{first_file}/func.feat/design.fsf') as file_o, \
            open(f'/home/fsluser/Documents/{project_name}'
                 f'/{file_name}/design.fsf', 'w') as file_1:
        for line in file_o:
            if f'/home/fsluser/Documents/{project_name}' \
               f'/{first_file}/func' in line:
                line = line.replace(f'/home/fsluser/Documents/'
                                    f'{project_name}/{first_file}/func',
                                    f'/home/fsluser/Documents/'
                                    f'{project_name}/{file_name}/func')
...
def regis(project_name, file_name):
    ...
    applyxfm.inputs.in_file = f'/home/fsluser/Documents/{project_name}' \
                              f'/{file_name}/func.feat' \
                              f'/filtered_func_data.nii.gz'
    applyxfm.inputs.in_matrix_file = f'/home/fsluser/Documents/{project_name}' \
                                     f'/{file_name}/func.feat/reg' \
                                     f'/example_func2standard.mat'
...
def func_fsl(project_name, file_namelist, first_name):
    for j in range(478, 493):
        ...
        shutil.move('/home/fsluser/PycharmProjects/fsl'
                    '/filtered_func_data_flirt.nii.gz',
                    f'/home/fsluser/Documents/{project_name}'
                    f'/{subject_name}/filtered_func_data_flirt.nii.gz')
